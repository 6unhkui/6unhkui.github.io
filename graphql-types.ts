...
export type SitePageFieldsEnum =
  ...
  | 'pluginCreator___pluginOptions___graphqlTypes'
...
export type SitePluginPluginOptions = {
  ...
  graphqlTypes?: Maybe<Scalars['String']>;
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  graphqlTypes?: Maybe<StringQueryOperatorInput>;
...
export type SiteQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      ...
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'github' | 'linkedin'>>, menuLinks?: Maybe<Array<Maybe<Pick<SiteSiteMetadataMenuLinks, 'name' | 'link'>>>> }
    )> }> };
