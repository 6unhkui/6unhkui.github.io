...
export type FileFieldsEnum =
  ...
  | 'childMarkdownRemark___frontmatter___menu'
...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___menuLinks___target'
  | 'port'
  | 'host'
  | 'polyfill'
  | 'pathPrefix'
...
export type SitePageFieldsEnum =
  ...
  | 'pluginCreator___pluginOptions___graphql_types'
  | 'pluginCreator___pluginOptions___documentPaths'
  | 'pluginCreator___pluginOptions___options___codegenPlugins'
...
export type SitePluginFieldsEnum =
  ...
  | 'pluginOptions___plugins___pluginOptions___elements'
  ...
  | 'pluginOptions___graphql_types'
  | 'pluginOptions___documentPaths'
  | 'pluginOptions___options___codegenPlugins'
  | 'pluginOptions___options___codegenPlugins___resolve'
...
export type SitePluginPluginOptions = {
  ...
  graphql_types?: Maybe<Scalars['String']>;
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  graphql_types?: Maybe<StringQueryOperatorInput>;
...
export type SitePluginPluginOptionsOptions = {
  codegenPlugins?: Maybe<Array<Maybe<SitePluginPluginOptionsOptionsCodegenPlugins>>>;
};

export type SitePluginPluginOptionsOptionsCodegenPlugins = {
  resolve?: Maybe<Scalars['String']>;
  options?: Maybe<SitePluginPluginOptionsOptionsCodegenPluginsOptions>;
};

export type SitePluginPluginOptionsOptionsCodegenPluginsFilterInput = {
  resolve?: Maybe<StringQueryOperatorInput>;
  options?: Maybe<SitePluginPluginOptionsOptionsCodegenPluginsOptionsFilterInput>;
};

export type SitePluginPluginOptionsOptionsCodegenPluginsFilterListInput = {
  elemMatch?: Maybe<SitePluginPluginOptionsOptionsCodegenPluginsFilterInput>;
};

export type SitePluginPluginOptionsOptionsCodegenPluginsOptions = {
  namingConvention?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsOptionsCodegenPluginsOptionsFilterInput = {
  namingConvention?: Maybe<StringQueryOperatorInput>;
};

export type SitePluginPluginOptionsOptionsFilterInput = {
  codegenPlugins?: Maybe<SitePluginPluginOptionsOptionsCodegenPluginsFilterListInput>;
};
...
export type PostsInfoFragment = { edges: Array<{ node: (
      Pick<MarkdownRemark, 'excerpt'>
      & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
        Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'tags' | 'category'>
        & { featuredImage?: Maybe<{ childImageSharp?: Maybe<{ resize?: Maybe<Pick<ImageSharpResize, 'src'>> }> }> }
      )> }
    ) }>, categories: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue'>> };

export type SeoQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SeoQueryQuery = { icon?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'src'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<(
...
export type SiteQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      ...
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'github' | 'linkedin'>>, menuLinks?: Maybe<Array<Maybe<Pick<SiteSiteMetadataMenuLinks, 'name' | 'link' | 'target'>>>> }
    )> }> };

export type AlgorithmPageQueryVariables = Exact<{ [key: string]: never; }>;


export type AlgorithmPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type CsPageQueryVariables = Exact<{ [key: string]: never; }>;


export type CsPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type DevOpsPageQueryVariables = Exact<{ [key: string]: never; }>;


export type DevOpsPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type EtcPageQueryVariables = Exact<{ [key: string]: never; }>;


export type EtcPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type IndexPageQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type ProgrammingPageQueryVariables = Exact<{ [key: string]: never; }>;


export type ProgrammingPageQuery = { allMarkdownRemark: PostsInfoFragment };

export type ProjectPageQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectPageQuery = { allMarkdownRemark: PostsInfoFragment };
...
export type PostSinglePageQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


export type PostSinglePageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'author'>> }>, markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html' | 'tableOfContents'>
    & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'category' | 'tags'>
      & { featuredImage?: Maybe<{ childImageSharp?: Maybe<{ original?: Maybe<Pick<ImageSharpOriginal, 'src' | 'width' | 'height'>> }> }> }
    )> }
  )> };
...
export type TagPageQuery = { allMarkdownRemark: (
    ...
    & { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'category'>
          & { featuredImage?: Maybe<{ childImageSharp?: Maybe<{ resize?: Maybe<Pick<ImageSharpResize, 'src'>> }> }> }
        )> }
      ) }> }
  ) };
...
export type Unnamed_1_Query = { allMarkdownRemark: { edges: Array<{ node: (
        ...
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'tags'>> }
      ) }> } };
